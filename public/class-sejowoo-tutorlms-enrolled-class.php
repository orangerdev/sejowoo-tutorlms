...
class EnrolledClass {
     ...
     * @var string
     */
    public static $endpoint = 'enrolled-class';
    ...
    public function register_my_account_endpoint( $query_vars ) {
        ...
        if(
            ...
            $query_vars['enrolled-class'] = 'enrolled-class';
    ...
    public function add_my_account_links( array $links ){
        ...
        if(
            ...
            $links['enrolled-class']     = __('Kelas Anda', 'sejowoo-tutorlms' );
     ...
     * Hooked via filter woocommerce_endpoint_allenrolled-class_title, priority 133
     * @since   1.0.0
     * @param   string  $title
     * @return  string
     */
    public function set_my_account_title( $title ) {
        ...
        return __('Kelas Anda', 'sejowoo-tutorlms');
